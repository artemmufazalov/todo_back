...
module.exports = createRoutes = (app) => {
    ...
    app.post('/user/password/change',userController.requestPasswordChange)
    app.post('/user/password/restore', userController.requestPasswordRestore)
    app.put('/user/password/update',userController.changePassword)
